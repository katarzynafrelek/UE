...
# Stworzyc klasy, po piec atrybutow z getterami i nadpisana metoda magiczna do opisania obiektu klasy.
# Jesli zasadne stworzyc klase bazowa i dziedziczyc ja przy definicji innej klasy
# Ustawienie wartosci atrybutow dla Zamowienia powinno sie odbywac z wykorzystaniem setterow,
# dla reszty klas moze sie to odbywac przez konstruktor
# Klasa zamowienie ma posiadac zaimplementowane metody:
# -do wyliczenia wartosci zamowienia na podstawie produktow, ktore sie na nim znajduja, zwracana cena ma byc
# zaokraglona do dwoch miejsc po przecinku
# -do zwracania adresu klienta, do ktorego ma zostac wyslane zamowienie3
# stworzyc jeden obiekt zamowienia i go wyswietlic
